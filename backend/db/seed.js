...
const DEFAULT_CATEGORIES = [
  ...
  ['bottle', 'القوارير الكبيرة', 'Large Bottles', 'قوارير 18.9 لتر للمنازل والمكاتب وأجهزة التبريد', 'fas fa-jug-detergent', 3],
  ['ice', 'الثلج', 'Ice', 'ثلج نقي بأحجام مختلفة للمشروبات والمناسبات', 'fas fa-snowflake', 4],
  ['extras', 'الكابونات والمستلزمات', 'Coupons & Extras', 'دفاتر كابونات ومضخات وفلاتر ومستلزمات المياه', 'fas fa-toolbox', 5]
];
